...
class EntrancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entrance" do
    assert_difference('Entrance.count') do
      post entrances_url, params: { entrance: { building_id: @entrance.building_id, latitude: @entrance.latitude, longitude: @entrance.longitude } }
    end
  ...
  test "should update entrance" do
    patch entrance_url(@entrance), params: { entrance: { building_id: @entrance.building_id, latitude: @entrance.latitude, longitude: @entrance.longitude } }
